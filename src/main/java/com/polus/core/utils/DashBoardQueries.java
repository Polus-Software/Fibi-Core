...
//	------------------------------------------------------Role------------------------------------
	String ROLE_WITH_UNIT = "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER \r\n" + 
	...
	String ROLE_WITH_ROLE = "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER \r\n" + 
			"			FROM PERSON_ROLES T1 \r\n" + 
			"			INNER JOIN PERSON T2 ON T1.PERSON_ID = T2.PERSON_ID\r\n" + 
			"			INNER JOIN UNIT T3 ON T1.UNIT_NUMBER = T3.UNIT_NUMBER \r\n" + 
			"			INNER JOIN UNIT T4 ON T4.UNIT_NUMBER = T2.HOME_UNIT \r\n" +
	...
	String ROLE_WITH_UNIT_AND_ROLE = "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER  \r\n" + 
			"			FROM PERSON_ROLES T1 \r\n" + 
			"			INNER JOIN PERSON T2 ON T1.PERSON_ID = T2.PERSON_ID\r\n" + 
			"			INNER JOIN UNIT T3 ON T1.UNIT_NUMBER = T3.UNIT_NUMBER \r\n" + 
			"			INNER JOIN UNIT T4 ON T4.UNIT_NUMBER = T2.HOME_UNIT \r\n" +
	...
	String FETCH_ALL_ROLES= "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER \r\n" + 
			"			FROM PERSON_ROLES T1 \r\n" + 
			"			INNER JOIN PERSON T2 ON T1.PERSON_ID = T2.PERSON_ID\r\n" + 
			"			INNER JOIN UNIT T3 ON T1.UNIT_NUMBER = T3.UNIT_NUMBER\r\n" + 
			"			INNER JOIN UNIT T4 ON T4.UNIT_NUMBER = T2.HOME_UNIT";
	
	String ROLES_OF_PERSON = "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER \r\n" + 
			"FROM PERSON_ROLES T1 \r\n" + 
			"INNER JOIN PERSON T2 ON T1.PERSON_ID = T2.PERSON_ID\r\n" + 
			"INNER JOIN UNIT T3 ON T1.UNIT_NUMBER = T3.UNIT_NUMBER \r\n" +
			"INNER JOIN UNIT T4 ON T4.UNIT_NUMBER = T2.HOME_UNIT \r\n" +
	...
	String ROLE_WITH_UNIT_AND_PERSON = "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER \r\n" + 
			"			FROM PERSON_ROLES T1 \r\n" + 
			"			INNER JOIN PERSON T2 ON T1.PERSON_ID = T2.PERSON_ID\r\n" + 
			"			INNER JOIN UNIT T3 ON T1.UNIT_NUMBER = T3.UNIT_NUMBER \r\n" + 
			"			INNER JOIN UNIT T4 ON T4.UNIT_NUMBER = T2.HOME_UNIT \r\n" +
	...
	String ROLE_WITH_UNIT_AND_PERSON_AND_ROLE = "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER \r\n" + 
			"			FROM PERSON_ROLES T1 \r\n" + 
			"			INNER JOIN PERSON T2 ON T1.PERSON_ID = T2.PERSON_ID\r\n" + 
			"			INNER JOIN UNIT T3 ON T1.UNIT_NUMBER = T3.UNIT_NUMBER \r\n" + 
			"			INNER JOIN UNIT T4 ON T4.UNIT_NUMBER = T2.HOME_UNIT \r\n" +
	...
	String ROLE_WITH_ROLE_AND_PERSON = "SELECT DISTINCT T1.PERSON_ID,T2.FULL_NAME,T2.EMAIL_ADDRESS,T2.USER_NAME,T3.UNIT_NAME,T1.UNIT_NUMBER,T2.PRIMARY_TITLE,T2.DIRECTORY_TITLE,T4.UNIT_NAME AS PERSON_HOME_UNIT,T4.UNIT_NUMBER AS PERSON_HOME_UNIT_NUMBER \r\n" + 
			"			FROM PERSON_ROLES T1 \r\n" + 
			"			INNER JOIN PERSON T2 ON T1.PERSON_ID = T2.PERSON_ID\r\n" + 
			"			INNER JOIN UNIT T3 ON T1.UNIT_NUMBER = T3.UNIT_NUMBER \r\n" + 
			"			INNER JOIN UNIT T4 ON T4.UNIT_NUMBER = T2.HOME_UNIT \r\n" +
...
//--------------------------------------------------------AGREEMENT-------------------------------------------------
		String AGREEMENT_SUMMARY_FOR_ADMIN = 
				 " WITH UNIT_ACCESS AS (SELECT DISTINCT UNIT_NAME FROM UNIT WHERE UNIT_NUMBER IN (SELECT UNIT_NUMBER FROM PERSON_ROLES T1 INNER JOIN ROLE_RIGHTS T2 ON T1.ROLE_ID = T2.ROLE_ID INNER JOIN RIGHTS T3 ON T2.RIGHT_ID = T3.RIGHT_ID  WHERE T1.DESCEND_FLAG = 'N' AND T1.PERSON_ID = :PERSON_ID AND RIGHT_NAME IN ('AGREEMENT_ADMINISTRATOR') UNION SELECT CHILD_UNIT_NUMBER FROM UNIT_WITH_CHILDREN  WHERE UNIT_NUMBER IN (SELECT UNIT_NUMBER FROM PERSON_ROLES T1 INNER JOIN ROLE_RIGHTS T2 ON T1.ROLE_ID = T2.ROLE_ID INNER JOIN RIGHTS T3 ON T2.RIGHT_ID = T3.RIGHT_ID  WHERE T1.DESCEND_FLAG = 'Y' AND T1.PERSON_ID = :PERSON_ID AND RIGHT_NAME IN ('AGREEMENT_ADMINISTRATOR'))))"
				+ " SELECT T2.CATEGORY_CODE AS CATEGORY_CODE, T2.DESCRIPTION AS CATEGORYS,\n" + 
								...
								"WHERE T1.AGREEMENT_SEQUENCE_STATUS NOT IN ('TEMPLATE') AND ((T1.UNIT_NUMBER IN (SELECT DISTINCT UNIT_NUMBER FROM UNIT_ACCESS) OR T3.PERSON_ID = :PERSON_ID OR T1.REQUESTOR_PERSON_ID = :PERSON_ID))) \n" + 
								"GROUP BY T2.CATEGORY_CODE,T2.DESCRIPTION";

						String AGREEMENT_SUMMARY_FOR_NON_ADMIN = "WITH UNIT_ACCESS AS (SELECT DISTINCT UNIT_NAME FROM UNIT WHERE UNIT_NUMBER IN (SELECT UNIT_NUMBER FROM PERSON_ROLES T1 INNER JOIN ROLE_RIGHTS T2 ON T1.ROLE_ID = T2.ROLE_ID INNER JOIN RIGHTS T3 ON T2.RIGHT_ID = T3.RIGHT_ID  WHERE T1.DESCEND_FLAG = 'N' AND T1.PERSON_ID = :PERSON_ID AND RIGHT_NAME IN ('VIEW_ALL_AGREEMENT','MODIFY_ALL_AGREEMENT') UNION SELECT CHILD_UNIT_NUMBER FROM UNIT_WITH_CHILDREN  WHERE UNIT_NUMBER IN (SELECT UNIT_NUMBER FROM PERSON_ROLES T1 INNER JOIN ROLE_RIGHTS T2 ON T1.ROLE_ID = T2.ROLE_ID INNER JOIN RIGHTS T3 ON T2.RIGHT_ID = T3.RIGHT_ID  WHERE T1.DESCEND_FLAG = 'Y' AND T1.PERSON_ID = :PERSON_ID AND RIGHT_NAME IN ('VIEW_ALL_AGREEMENT','MODIFY_ALL_AGREEMENT'))))"
						 + " SELECT T2.CATEGORY_CODE AS CATEGORY_CODE,T2.DESCRIPTION AS CATEGORYS, SUM(CASE WHEN T1.AGREEMENT_STATUS_CODE in (1,6) THEN 1 ELSE 0 END )AS \"DRAFT\", \n" +
								"SUM(CASE WHEN T1.AGREEMENT_STATUS_CODE in (2,5,7) THEN 1 ELSE 0 END )AS \"IN WORKFLOW\" FROM AGREEMENT_HEADER  T1 \n" +
								"INNER JOIN AGREEMENT_CATEGORY T2 ON T1.CATEGORY_CODE = T2.CATEGORY_CODE  \n" +
								"WHERE T1.AGREEMENT_REQUEST_ID IN ( \n" +
								"SELECT DISTINCT T4. AGREEMENT_REQUEST_ID FROM AGREEMENT_HEADER  T4 \n" +
								"LEFT JOIN AGREEMENT_PEOPLE T3 on T4.AGREEMENT_REQUEST_ID = T3.AGREEMENT_REQUEST_ID  \n" +
								"WHERE T1.AGREEMENT_SEQUENCE_STATUS NOT IN ('TEMPLATE') AND ((T1.UNIT_NUMBER IN(SELECT DISTINCT UNIT_NUMBER FROM UNIT_ACCESS) OR (T3.PERSON_ID = :PERSON_ID AND T3.PEOPLE_TYPE_ID = 3) OR T1.REQUESTOR_PERSON_ID = :PERSON_ID))) \n" + 
								"GROUP BY T2.CATEGORY_CODE,T2.DESCRIPTION";
}
